"""A hello-world filter plugin in my_new_collection_namespace_02.my_new_collection_name_02."""
...
DOCUMENTATION = """
    name: hello_world
    author: My_new_collection_namespace_02 My_new_collection_name_02
    version_added: "1.0.0"
